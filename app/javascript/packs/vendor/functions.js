...
//Init navbar burger
export function initNavbarBurger() {
...
export function initProductDetailsLinks(){
...
export function initOrderDetailsLinks() {
...
//Destroy popovers
export function destroyPopovers(){
...
export function opitimizePopovers() {
    if (window.matchMedia('(max-width: 767px)').matches) {
...
export function initPopButtons() {
...
//Closable message
export function initClosableMessage(){
...
export function launchAlert(title, message, okLabel, cancelLabel, callback) {
